...
int main()
{
    ...
    cout<< "Cac so hoan hao nho hon m la:";
    long long countSohoanhao = 0;
    long long sumSohoanhao = 0;
    for(long long i=2; i<mPrime; i++){
        if(perfect(i)){
            cout<< i << " ";
            countSohoanhao++;
            sumSohoanhao += i;
    ...
    cout<< "\nSo luong so hoan hao nho hon m la: " << countSohoanhao << "\n";
    cout<< "Tong cac so hoan hao nho hon m la: " << sumSohoanhao << "\n";
    delete[] divs;
    return 0;
}